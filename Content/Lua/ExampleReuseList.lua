...
function ExampleReuseList:construct()
    ...
    self.widget.ExampleCommonBgUI.EventClosed:Add(function() self:Close() end)
...
function ExampleReuseList:destruct()
    ...
    self.widget.ExampleCommonBgUI.EventClosed:Clear()
...
function ExampleReuseList:OnClickItem1()
    ...
    self.widget.ReuseList2.OnCreateItem:Clear()
    self.widget.ReuseList2.OnCreateItem:Add(function(widget)
        TestReuseListItem.bind(widget, self)
...
function ExampleReuseList:OnClickItem2()
