...
#include "UWrapBoxEx.generated.h"
...
UCLASS()
class EXAMPLE_UE4_API UWrapBoxEx : public UWrapBox
{
    GENERATED_BODY()
...
public:
    ...
    UWrapBoxEx(const FObjectInitializer& ObjectInitializer);
...
DECLARE_LOG_CATEGORY_EXTERN(LogUWrapBoxEx, Verbose, All);